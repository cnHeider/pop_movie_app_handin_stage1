...
public class PlaylistFragment extends Fragment implements FavoritesCursorAdapter.FavoritesCursorAdapterOnClickHandler {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    Cursor movieCursor = mContext.getContentResolver().query(MovieContract.MovieEntry.CONTENT_URI, null,
        MovieContract.MovieEntry.COLUMN_PLAYLIST + " = 1", null, null);
